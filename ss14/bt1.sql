...
-- Giả lập sự cổ hệ thồng bát ngờ xảy ra tại đây (Cúp điện, rớt mạng ... )
SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Lôi: Hệ thong gặp sự co mang đột ngot!';
...
CALL PayHospitalFee(1,400000);

SELECT * FROM Wallets;

SELECT * FROM Patient_Invoices;

-- khi chạy thì tiền của Wallets vẫn giảm , còn của Patient_Invoices thì k giảm , bởi vì khi chạy lệnh update 
-- của Wallets sau đó log ra một câu lệnh giả lập lỗi , nên sau đó nó sẽ dừng luôn và không chạy câu lệnh dưới 
...
BEGIN
    ...
    SET MESSAGE_TEXT = 'Loi he thong bat ngo';
